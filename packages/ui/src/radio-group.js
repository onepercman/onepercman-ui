...
export const radioGroup = tv({
    ...
    slots: {
        ...
        itemText: "",
        control: "flex rounded-full border-2 border-border p-1 text-sm text-transparent duration-300 after:h-full after:w-full after:rounded-full after:bg-transparent after:content-[''] data-[hover]:border-primary data-[state=checked]:border-primary data-[state=checked]:after:bg-primary",
    },
    variants: {
        size: {
...
const CustomItem = React.forwardRef(function (_a, ref) {
    ...
    return (_jsxs(Item, Object.assign({ ref: ref }, props, { children: [_jsx(ItemControl, {}), _jsx(ItemText, { children: children }), _jsx(ItemHiddenInput, {})] })));
});
